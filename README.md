...
Run the following comamnd which should install the `latest` version (`1.0.0-alpha.4-21d6bf5`):

```bash
npm install ngx-ytd-api --save
```

#### `1.0.0-alpha.4-21d6bf5` and up

Versions `1.0.0-alpha.4-21d6bf5` now require the `ngx-simple-http` dependency. Install it as well:
