...
Run the following comamnd which should install the `latest` version (`1.0.0-alpha.4-18bc502`):

```bash
npm install ngx-ytd-api --save
```

#### `1.0.0-alpha.4-18bc502` and up

Versions `1.0.0-alpha.4-18bc502` now require the `ngx-simple-http` dependency. Install it as well:
