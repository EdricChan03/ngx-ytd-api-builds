...
Run the following comamnd which should install the `latest` version (`1.0.0-alpha.4-478681f`):

```bash
npm install ngx-ytd-api --save
```

#### `1.0.0-alpha.4-478681f` and up

Versions `1.0.0-alpha.4-478681f` now require the `ngx-simple-http` dependency. Install it as well:
