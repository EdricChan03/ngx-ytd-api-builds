...
import { NgxYtdApiCommentThreadsInsertParams, NgxYtdApiCommentThreadsListParams, NgxYtdApiCommentThreadsListResponse, NgxYtdApiCommentThreadsResource, NgxYtdApiCommentThreadsUpdateParams } from './ytd-api-comment-threads.interface';
export declare class NgxYtdApiCommentThreadsService {
    private common;
